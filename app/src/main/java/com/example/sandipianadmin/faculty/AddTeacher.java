package com.example.sandipianadmin.faculty;
...
import com.example.sandipianadmin.NoticeData;
import com.example.sandipianadmin.R;
import com.example.sandipianadmin.UploadImage;
import com.example.sandipianadmin.UploadNotice;
...
public class AddTeacher extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String [] items = new String[]{"Select Category", "B.TECH","B.C.A", "B.B.A","B.SC AGRICULTURE","MBA"};
