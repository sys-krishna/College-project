...
public class UploadNotice extends AppCompatActivity {
    ...
    private DatabaseReference reference, dbRef;                     // for database
...
//----------------------------------this method mainly use for firebase storage data------------------------
...
//--------------------- Time Store------------------------------
        ...
        dbRef.child(uniquekey).setValue(noticeData).addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onFailure(@NonNull Exception e) {
                pd.dismiss();
                Toast.makeText(UploadNotice.this, "Something went wroing", Toast.LENGTH_SHORT).show();
            }
        });
    }
